window.addEventListener('load', function() {
    ...
    const sentenceTranslationBtn = document.getElementById("sentencePage");

    sentenceTranslationBtn.addEventListener("click", () => {
        window.location.href = "/sentenceTranslation";
    })
